package com.example.aryamirshafii.resumewriterexcel;
...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks  {
   ...
   // private TabLayout mTabLayout;
    ...
    public void getResultsFromApi() {
        System.out.println("Calling Google Drive Api");
    ...
    class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        protected List<String> doInBackground(Void... params) {
            try {
                if(dataManager.getFolderID() == null){
                    if(dataManager.getFirstname() != null && dataManager.getLastName() != null){
                        String folderName = dataManager.getFirstname() + "_" + dataManager.getLastName();
