    ...
    private String inputUserData(String htmlString,int resumeNumber){
        ...
        if(resumeNumber ==1){
            ...
            if(!dataManager.getExperience().isEmpty()){
                ...
                beingLookedAt = beingLookedAt.replace("<dd class=\"clear\"></dd><dt>Experience</dt><dd>ExperienceGoHere</dd>",
                        "");
            }
            ...
            if(!dataManager.getExtracurricular().isEmpty()){
                ...
                beingLookedAt = beingLookedAt.replace( "<dd class=\"clear\"></dd><dt>Extracurriculars</dt><dd>extracurricularsGoHere</dd>",  "");
            }
